...
public class DestructOfBuilding : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D collider)
    {
        ...
        if (this.Sturctue_Mine && this.tag == "buildings" && collider.gameObject.GetComponent<Attack>() != null && collider.gameObject.transform.parent.parent.gameObject.name == "enemy soldiers"
            || !this.Sturctue_Mine && this.tag == "buildings" && collider.gameObject.GetComponent<Attack>() != null && collider.gameObject.transform.parent.parent.gameObject.name == "colony soldiers")
        {
        ...
        {
            if (this.Sturctue_Mine && this.tag == "buildings" && collision.gameObject.GetComponent<Attack>() != null && collision.gameObject.transform.parent.parent.gameObject.name == "enemy soldiers"
                 || !this.Sturctue_Mine && this.tag == "buildings" && collision.gameObject.GetComponent<Attack>() != null && collision.gameObject.transform.parent.parent.gameObject.name == "colony soldiers")
            {
