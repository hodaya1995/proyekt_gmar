...
public class DestructOfBuilding : MonoBehaviour
{
    ...
    void Start()
    {
            ...
            || this.name.Contains("colony archer building") || this.name.Contains("colony barracks building"))
        {
            ...
            slide.value = Bar_Life_Building;
            this.gameObject.tag = "building";
            Destruct_Building = Instantiate(GameObject.Find("characters").transform.Find("colony soldiers").Find("buildings").Find("destruct building").gameObject);
            Destruct_Building.transform.SetParent(this.gameObject.transform);
            Destruct_Building.SetActive(false);
            ...
            || this.name.Contains("enemy archer building") || this.name.Contains("enemy barracks building"))
        {
            ...
            slide.value = Bar_Life_Building;
            this.gameObject.tag = "building";
            Destruct_Building = Instantiate(GameObject.Find("characters").transform.Find("enemy soldiers").Find("buildings").Find("destruct building").gameObject);
            Destruct_Building.transform.SetParent(this.gameObject.transform);
            Destruct_Building.SetActive(false);
    ...
    void OnCollisionEnter2D(Collision2D collider)
    {
        ...
        if (this.Sturctue_Mine && this.tag.Contains("building") && collider.gameObject.GetComponent<Attack>() != null && collider.gameObject.tag == "enemy soldier"
            || !this.Sturctue_Mine && this.tag.Contains("building") && collider.gameObject.GetComponent<Attack>() != null && collider.gameObject.tag == "colony soldier")
        {
    ...
    void OnCollisionExit2D(Collision2D collision)
    {
        if (this.Sturctue_Mine && this.tag.Contains("building") && collision.gameObject.GetComponent<Attack>() != null && collision.gameObject.tag == "enemy soldier"
             || !this.Sturctue_Mine && this.tag.Contains("building") && collision.gameObject.GetComponent<Attack>() != null && collision.gameObject.tag == "colony soldier")
        {
            Animator a = collision.gameObject.GetComponent<Animator>();
            a.SetBool("toAttack", false);
