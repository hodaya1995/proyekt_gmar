        ...
        if (detectedTouch)
        {
            if (Use_Move_Building_To_Build && No_Other_Build_In_Field)
            {
                ...
                if (Move_Building_To_Build.name == "stable move")
                {
                    ...
                    building = "colony stable";
                    //buildingofshai = "stable";
                }
                ...
                else if (Move_Building_To_Build.name == "barracks move")
                {
                    ...
                    countxet.text = " " + num;
                    numberOfResource = num;
                    building = "colony barracks building";
                    //buildingofshai = "barracks";
                }
                ...
                else if (Move_Building_To_Build.name == "archer building move")
                {
                    ...
                    countxet.text = " " + num;
                    numberOfResource = num;
                    building = "colony archer building";
                    //buildingofshai = "archer building";
                }
                ...
                else if (Move_Building_To_Build.name == "worker building move")
                {
                    ...
                    countxet.text = " " + num;
                    numberOfResource = num;
                    building = "colony worker building";
                    //buildingofshai = "worker building";
                }
                ...
                else if (Move_Building_To_Build.name == "protect tower move")
                {
                    ...
                    countxet.text = " " + num;
                    numberOfResource = num;
                    building = "colony protect tower";
                    //buildingofshai = "protect tower";

                }
                buildingofshai = building;
                ...
                start_building.GetComponent<Build_Building>().Set_Name_Building_shai(buildingofshai);
            ...
            if (hitInformation.collider != null)
            {
                ...
                Resource.setToolBarColors(number);
                //Tool_Buildings.gameObject.SetActive(true);
